...
public class SelectorUsuario extends javax.swing.JDialog {
	...
	public static void main(String args[]){
		new SelectorUsuario(null,true);
	}
	
    public SelectorUsuario(java.awt.Frame parent, boolean modal) {
    ...
    private ComboBoxModel getUsuarios(){
    	
    	System.out.println("obteniendo usuarios");
    	
    	File carpetaCertificados = new File("cal\\certificados");
    	
    	File[] zips = carpetaCertificados.listFiles(new FilenameFilter(){
